            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3 mt-4">
                  <div className="flex items-center justify-center gap-2 rounded-xl bg-white/10 backdrop-blur-sm border border-white/20 px-4 py-3 text-sm text-white">
                    <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M3 20.5v-17c0-.83.67-1.5 1.5-1.5h15c.83 0 1.5.67 1.5 1.5v17c0 .83-.67 1.5-1.5 1.5h-15c-.83 0-1.5-.67-1.5-1.5zm11.5-6.5l-5 5H18l-3.5-5zm-4.97 3.97L6.5 15h3L12 12.5 9.53 18zm8.22-4.72l-2.25-3L13 14l2.75 3.75L20.5 12zM12 9a2 2 0 1 1 0-4 2 2 0 0 1 0 4z"/>
                    </svg>
                    <span className="font-medium">Google Play</span>
                    <span className="text-xs bg-yellow-500/80 text-yellow-900 px-2 py-0.5 rounded-full ml-1">Soon</span>
                  </div>
                  <div className="flex items-center justify-center gap-2 rounded-xl bg-white/10 backdrop-blur-sm border border-white/20 px-4 py-3 text-sm text-white">
                    <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
